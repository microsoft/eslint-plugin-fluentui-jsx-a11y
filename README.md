...
| [tablist-and-tabs-need-labelling](docs/rules/tablist-and-tabs-need-labelling.md)                       | Accessibility: Tablist requires an accessible name, and Tabs must have an 'aria-label' when using icons
