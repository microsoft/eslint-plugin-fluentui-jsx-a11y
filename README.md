...
| [prefer-aria-over-title-attribute-v9](docs/rules/prefer-aria-over-title-attribute-v9.md)                     | The title attribute is not consistently read by screen readers, and its behavior can vary depending on the screen reader and the user's settings.                                                                      | 🔧 |
