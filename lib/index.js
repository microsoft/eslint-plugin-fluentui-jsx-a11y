...
module.exports = {
    rules: {
        ...
        "icon-text-content-button-does-not-need-aria": require("./rules/icon-text-content-button-does-not-need-aria"),
        "image-button-missing-aria": require("./rules/image-button-missing-aria"),
        "image-button-prefer-aria-over-title-attribute": require("./rules/image-button-prefer-aria-over-title-attribute"),
        ...
        "object-literal-button-no-missing-aria": require("./rules/object-literal-button-no-missing-aria"),
        ...
        "text-content-button-does-not-need-aria": require("./rules/text-content-button-does-not-need-aria"),
    ...
    configs: {
        recommended: {
            rules: {
                ...
                "@microsoft/fluentui-jsx-a11y/icon-text-content-button-does-not-need-aria": "error",
                "@microsoft/fluentui-jsx-a11y/image-button-missing-aria": "error",
                "@microsoft/fluentui-jsx-a11y/image-button-prefer-aria-over-title-attribute": "error",
                ...
                "@microsoft/fluentui-jsx-a11y/object-literal-button-no-missing-aria": "error",
                "@microsoft/fluentui-jsx-a11y/switch-needs-labelling-v9": "error",
                "@microsoft/fluentui-jsx-a11y/text-area-missing-label-v9": "error",
                "@microsoft/fluentui-jsx-a11y/text-content-button-does-not-need-aria": "error",
