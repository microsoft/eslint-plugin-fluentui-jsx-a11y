...
module.exports = {
    meta: {
        ...
        messages: {
            unnecessaryAriaLabelling: "Accessibility: a button with text content does not need aria labelling"
        },
    ...
    create(context) {
        return {
            ...
            JSXOpeningElement(node) {
                ...
                // the button does not have unnecessary labelling
                if (!hasAccessibleLabelling) {
                    return;
                }

                // the button has unnecessary labelling
                context.report({
                    node,
